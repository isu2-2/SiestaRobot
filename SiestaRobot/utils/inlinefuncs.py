...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/122c6f9823106b704da12.png",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/PcGamesAllForFree"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Siesta Robot ❤️](https://t.me/PcGamesAllForFree):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [OWNER BOT](t.me/Anant_Goel)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
